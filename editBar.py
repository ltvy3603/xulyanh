...
class EditBar(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.remove_background = Button(self, text="Resize")
        ...
        self.remove_background.bind("<ButtonRelease>", self.resize_button_released)
        ...
        self.remove_background.pack(side=LEFT)
    ...
    def resize_button_released(self, event):
        image = self.master.original_image
